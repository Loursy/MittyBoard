  ...
  ({ className, variant = "secondary", size = "md", isLoading, disabled, children, ...props }, ref) => {
    return (
      <button
        ...
        className={cn(
          "focus-ring inline-flex items-center rounded-lg font-medium transition-all duration-150 cursor-pointer active:scale-[0.98] disabled:cursor-not-allowed disabled:active:scale-100",
